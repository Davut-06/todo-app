...
abstract class AppLocalizations {
  ...
  /// No description provided for @editTaskName.
  ///
  /// In en, this message translates to:
  /// **'Edit task name'**
  String get editTaskName;
  ...
  /// No description provided for @errorAddingTask.
  ///
  /// In en, this message translates to:
  /// **'Error adding task: {error}'**
  String errorAddingTask(Object error);

  /// No description provided for @errorEditingTask.
  ///
  /// In en, this message translates to:
  /// **'Error editing task: {error}'**
